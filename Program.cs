            ...
            foreach (var player in players)
            {
                ...
                foreach (var prop in properties)
                {
                    ...
                    if (skillAttribute is not null)
                    {
                        ...
                        {
                            errors.Add(new Error(prop.Name, $"Invalid value Accepted Range is {skillAttribute.Minimum}--{skillAttribute.Maximum}"));
                        }
                    }
                }
                    ...
                    {
                        Console.WriteLine("players info are vaild");
